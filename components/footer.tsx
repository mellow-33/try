...
export default function Footer() {
  return (
    <footer className="w-full pb-0 relative overflow-hidden bg-[#FFFDF7]">
      <div className="container mx-auto px-4 flex flex-col items-center justify-center text-center">
        {/* Testo Gigante Sfumato (Gradient Text) */}
        <div className="w-full mt-24 md:mt-28 flex justify-center select-none pointer-events-none">
          <h1 
